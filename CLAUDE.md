...
> * **не сделано: приём заявок с контактной формы.** В модели данных нет
>   таблицы под них, а заводить её значит решать за владельца бэкенда, как
>   устроены заявки. Готовый план на полчаса работы — в `README.md`,
>   раздел «Заявки с формы».
